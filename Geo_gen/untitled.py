...
def create_markers_for_locations(map): 
...
def cluster_and_visualize(map):
    marker_cluster = MarkerCluster().add_to(map)
    create_markers_for_locations(marker_cluster)
