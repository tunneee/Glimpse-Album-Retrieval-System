...
class ImageSelector(object):
    ...
    def __prepare_cluster_sets__hdbscan(self, files):
        ...
        # Hdbascan = hdbscan.HDBSCAN(min_cluster_size=2,metric='euclidean').fit(all_dst)
    ...
    def select_best_frames(self, input_key_frames, output_folder=None):
    # def select_best_frames(self, input_key_frames, number_of_frames):
        ...
        return filtered_images_list, selected_images_index